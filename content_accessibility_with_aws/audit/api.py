...
from content_accessibility_with_aws.audit.auditor import AccessibilityAuditor

# IMPORTANT FIX: Import from the correct module path
from content_accessibility_with_aws.audit.report_generator import generate_report
