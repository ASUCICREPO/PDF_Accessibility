...
from content_accessibility_with_aws.pdf2html.services.page_builder import build_html_data
...
class ExtendedBDAClient(BDAClient):
    ...
    def _extract_html_from_result_json(self, json_file_path, output_dir):
        ...
        try:
            ...
            from content_accessibility_with_aws.pdf2html.services.image_mapper import (
